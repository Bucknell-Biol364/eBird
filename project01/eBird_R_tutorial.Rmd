...
R can be tricky, especially if you’re new to it, but there are many resources available. Google is a great place to start: try typing in “how to I get ____ in R?” The results will often get you moving in the right direction. TOn RStudio’s website there are also plenty of "cheatsheets" which even seasoned R-users use for reference. Each cheatsheet corresponds with a package so you can learn all about the important commands within that package. You also never need to code from scratch! Re-use code you or others have already written and that works, like you copy and pasted throughout this tutorial, it makes your life so much easier. Happy coding!
